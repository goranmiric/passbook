/**
 * @file
 * Javascript for the passbook editing form.
 */
...
(function ($, Drupal) {
   ...
   */
  Drupal.behaviors.passbookTypes = {
    attach: function (context) {
      var $context = $(context);
      // Provide the vertical tab summaries.
      $context.find('#edit-submission').drupalSetSummary(function (context) {
        var vals = [];
        vals.push(Drupal.checkPlain($(context).find('#edit-label-label').val()) || Drupal.t('Requires a title'));
        return vals.join(', ');
      });
